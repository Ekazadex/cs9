    ...
    <footer className="bg-gray-800 text-gray-200 w-full">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">Depok, Indonesia</span>
              </li>
              <li className="flex items-center space-x-3">
                <FiPhone className="text-white" />
                <span className="text-gray-400">+62 812-966-9495</span>
              </li>
              <li className="flex items-center space-x-3">
                <FiMail className="text-white" />
                <span className="text-gray-400">support@zadex.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {currentYear} Zadex. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
